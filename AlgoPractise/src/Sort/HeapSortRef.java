 ...
 */
public class HeapSortRef {
	private Integer[] heapData;
	private int currentPosition = -1;
	
	public HeapSortRef(int size) {
	...
	public static HeapSortRef heapify(int[] data) {
		HeapSortRef heap = new HeapSortRef(data.length);
	...
	public static void main(String[] args) {
		HeapSortRef heap = new HeapSortRef(10);
		heap.insert(10);
		heap.insert(15);
		heap.insert(27);
		heap.insert(5);
...
//		System.out.println(heap.deleteRoot());
		...
		HeapSortRef another = HeapSortRef.heapify(new int[]{73,16,40,1,46,28,12,21,22,44,66,90,7});
